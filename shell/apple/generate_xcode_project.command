...
cmake -B build -DCMAKE_BUILD_TYPE=Release $option -DUSE_BREAKPAD=NO -DCMAKE_SKIP_PRECOMPILE_HEADERS=YES -DCMAKE_XCODE_GENERATE_SCHEME=YES -DLIBRETRO=ON -G "Xcode"
